    ...
    <main class="flex gap-5 justify-between relative top-[0px] w-full">
      ...
      <div class="main-content bg-white w-full py-0 h-full px-5">
        ...
        >
          ...
          <!-- Admission Application Process Section -->
          <div class="w-full mt-10">
            <div
              class="bg-green-100 font-bold my-4 text-green-800 flex items-center gap-2 px-3 py-3 rounded-lg mb-5"
            >
              <i class="fa fa-caret-down text-[20px]"></i>
              <h2 class="text-[16px]">Admission Application Process Section</h2>
            </div>
            ...
            <div class="process-title mt-5">
              ...
              <n-input
                type="text"
                v-model:value="process_title"
                bordered="false"
                placeholder="Application Process (Step-by-Step)"
                class="w-full text-[rgba(187,210,236,1)] font-[400] text-[16px] leading-[140%] tracking-[0%] py-[8px] px-[12px] rounded-[6px]"
              />
            </div>

            <div class="application-process mt-5">
              <h2
                class="text-[rgba(61,58,121,1)] flex justify-between items-center leading-[140%] tracking-[0%] font-[600] text-[16px] mb-2"
              >
                Add Application Process (Step-by-Step)

                <span
                  @click="addApplicationProcess"
              ...
              <div class="space-y-2 mt-3">
                <div
                  ...
                  v-for="(applicationProcess, index) in applicationProcesses"
                  :key="applicationProcess.id"
                >
                  <n-input
                    v-model:value="applicationProcess.value"
                    type="text"
                    bordered="false"
                  ...
                  />
                  <button
                    @click="removeApplicationProcess(index)"
            ...
            <div class="admission-requirement mt-5">
              <h2
                class="text-[rgba(61,58,121,1)] flex justify-between items-center leading-[140%] tracking-[0%] font-[600] text-[16px] mb-2"
              >
              ...
              <div class="space-y-2 mt-3">
                <div
                  class="flex items-center gap-2"
                  v-for="(
                    addmissionRequirement, index
                  ) in addmissionRequirements"
                  :key="addmissionRequirement.id"
                >
                  <n-input
                    v-model:value="addmissionRequirement.value"
                    type="text"
                    bordered="false"
                    placeholder="Enter Admission requirement"
                    class="w-full text-[rgba(187,210,236,1)] font-[400] text-[16px] leading-[140%] tracking-[0%] py-[8px] px-[12px] rounded-[6px]"
...
const applicationProcesses = ref([{ id: Date.now(), value: "" }]);

function addApplicationProcess() {
  applicationProcesses.value.push({ id: Date.now(), value: "" });
}

function removeApplicationProcess(index) {
  applicationProcesses.value.splice(index, 1);
}
// Add Events
...
const addmissionRequirements = ref([{ id: Date.now(), value: "" }]);
