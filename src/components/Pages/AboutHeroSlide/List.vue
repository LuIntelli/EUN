...
import { listAboutHeroSlide, deleteAboutHeroSlide } from "@/services/Pages";
...
const fetchData = async () => {
  loading.value = true;
  try {
    const res = await listAboutHeroSlide(); // from your services
...
const columns = [
    ...
    render(row) {
      return h(
        "a",
        {
          ...
          onClick: () => router.push(`/about-slide/edit/${row.id}`),
        },
        row.id
      );
    },
  ...
  { title: "About Page Title", key: "about_page_title" },
