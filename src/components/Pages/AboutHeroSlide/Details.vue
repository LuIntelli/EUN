...
import { editAboutHeroSlide, aboutHeroSlideDetails } from "@/services/Pages";
...
const fetchData = async () => {
  try {
    ...
    const data = await aboutHeroSlideDetails(id);
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await editAboutHeroSlide(route.params.id, payload);
