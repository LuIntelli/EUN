...
import { editTestimonials, testimonialsDetails } from "@/services/Pages";
...
const fetchData = async () => {
  try {
    ...
    const data = await testimonialsDetails(id);
    Object.assign(formData, data.data);
    Preview.value = formData["student_photo"];
    delete formData.student_photo;
  } catch (error) {
...
const handleSubmit = async () => {
  ...
  try {
    ...
    console.log("Start submitting...", formData);
    await editTestimonials(route.params.id, formData);
