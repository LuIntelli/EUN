...
import {
  editWhyChooseFeatures,
  whyChooseFeaturesDetails,
} from "@/services/Pages";
...
const fetchData = async () => {
  try {
    ...
    const data = await whyChooseFeaturesDetails(id);
...
const handleSubmit = async () => {
  ...
  try {
    ...
    console.log("Start submitting...", formData);
    await editWhyChooseFeatures(route.params.id, formData);
    message.success("updated successfully");
    router.push("/page/why-choose-features");
  } catch (err) {
    console.error(err);
