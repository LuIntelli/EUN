  ...
  <div class="p-6 w-full mx-auto">
    ...
    >
      <n-form-item label="Home Page" path="homepage">
        <n-input v-model:value="formData.homepage" placeholder="2" />
      </n-form-item>
...
import { editHeroSlides, heroSlideDetails } from "@/services/Pages";
...
const fetchData = async () => {
  try {
    ...
    const data = await heroSlideDetails(id);
    Object.assign(formData, data.data);
    Preview.value = formData["background_image"];
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await editHeroSlides(route.params.id, payload);
