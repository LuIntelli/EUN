  ...
  <div class="p-6 w-full mx-auto">
    ...
    >
      ...
      <n-form-item label="Code" path="code">
        <n-input v-model:value="formData.code" placeholder="2" />
      </n-form-item>
      ...
      <n-form-item label="level" path="level">
        <n-input v-model:value="formData.level" placeholder="Lagos" />
      </n-form-item>
...
import { modulesDetails, editModule, listCourse } from "@/services/Courses";
...
const fetchData = async () => {
  try {
    const res = await modulesDetails(route.params.id);
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await editModule(route.params.id, formData);
