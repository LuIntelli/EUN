...
import { admissionPageDetails, editAdmissionPage } from "@/services/Admission";
...
const handleSubmit = async () => {
  ...
  try {
    ...
    console.log("Start submitting...", formData);
    await editAdmissionPage(route.params.id, formData);
