...
import { editEventCategory, EventCategoryDetails } from "@/services/Event";
...
const fetchData = async () => {
  try {
    const res = await EventCategoryDetails(route.params.id);
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await editEventCategory(route.params.id, formData);
