<template>
  ...
  <div class="p-6 w-full mx-auto">
    <h2 class="text-2xl font-bold text-[rgba(61,58,121,1)] mb-6">
      Update Faculty Leadership Roles
    </h2>
...
import {
  editFacultyLeadershipRoles,
  facultyLeadershipRolesDetails,
...
const fetchData = async () => {
  try {
    ...
    const data = await facultyLeadershipRolesDetails(id);
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await editFacultyLeadershipRoles(route.params.id, formData);
