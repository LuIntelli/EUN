      ...
      <div class="p-5">
        ...
        <div class="form">
          ...
          >
            ...
            <div class="top mt-[-10px] mb-4 flex gap-5">
            ...
            <button
              type="submit"
              class="bg-[rgba(43,54,116,1)] flex gap-2 items-center text-white font-bold px-10 py-3 w-full justify-center rounded"
            >
              <i class="pi pi-user"></i>Create Admin User
            </button>
          </n-form>
          <!-- <div
